...
const kelasA1SortedAsc = kelasA1.sort(function(a, b) {
    return a.nilai - b.nilai
})

console.log('Daftar Nilai kelas A1 - Ascending',kelasA1SortedAsc);
...
const kelasA2SortedAsc = kelasA2.sort(function(a, b) {
    return a.nilai - b.nilai
})

console.log('Daftar Nilai kelas A2 - Ascending',kelasA2SortedAsc);
...
const kelasA3SortedAsc = kelasA3.sort(function(a, b) {
    return a.nilai - b.nilai
})


console.log('Daftar Nilai kelas A3 - Ascending', kelasA3SortedAsc);
